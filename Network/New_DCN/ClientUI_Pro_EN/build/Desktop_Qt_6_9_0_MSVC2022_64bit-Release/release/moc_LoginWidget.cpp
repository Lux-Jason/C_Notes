...
template <> constexpr inline auto LoginWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'connectRes'
        QtMocHelpers::SlotData<void(const ConnectRes &)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 2 },
        }}),
        // Slot 'loginRes'
        QtMocHelpers::SlotData<void(const LoginRes &)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 2 },
        }}),
        // Slot 'on_connBtn_clicked'
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->connectRes((*reinterpret_cast< std::add_pointer_t<ConnectRes>>(_a[1]))); break;
        case 2: _t->loginRes((*reinterpret_cast< std::add_pointer_t<LoginRes>>(_a[1]))); break;
        case 3: _t->on_connBtn_clicked(); break;
